...
class TestPostDao:
    ...
    def test_get_one_check_type_has_correct_pk(self, posts_dao, post_pk):
        ...
        post["pk"] == post_pk
        assert post["pk"] == post_pk, "Номер полученного поста не соответствует номер запрашиваемого"
    ...
    def test_get_by_used_correct_match(self, posts_dao, user_name, correct_pks):
